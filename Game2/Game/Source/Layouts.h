...
const TileType g_MainMap[g_MainMapWidth * g_MainMapHeight] =
{
    ...
    TT_Stone, TT_Empty, TT_Empty, TT_Empty, TT_Grass, TT_Grass, TT_Grass, TT_Stone, TT_Stone, TT_Stone,
    TT_Stone, TT_Empty, TT_Stone, TT_Empty, TT_Stone, TT_Stone, TT_Stone, TT_Stone, TT_Stone, TT_Stone,
    TT_Stone, TT_Stone, TT_Stone, TT_Stone, TT_Stone, TT_Stone, TT_Stone, TT_Stone, TT_Stone, TT_Stone,
